...
sns.kdeplot(sbi_df['Gain'],legend='sbi')
sns.kdeplot(hdfc_df['Gain'],legend='hdfc')
sns.kdeplot(dsp_df['Gain'],legend='DSP')
sns.kdeplot(axis_df['Gain'],legend='AXIS')
...
print("Gain above 4%")
print("ICICI Mutual Fund",ic_cdf1)
